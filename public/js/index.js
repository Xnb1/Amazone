   ...
   if (home) {
      home.forEach(hom => { 
         hom.addEventListener("click", async () => {
            ...
            try {
               const url = "https://amazone-54bq.onrender.com/";
  ...
  if (btn2) {
    btn2.addEventListener("click", async ()=> {
      //  console.log("button was clicked");
       try {
          let url = "https://amazone-54bq.onrender.com/signin";
...
btn3.addEventListener("click", () => {
   console.log(btn3);
   url = "https://amazone-54bq.onrender.com/signin";
...
divs.forEach(div => {               // querySelectorAll returns a nodeList (which is similar to array) so i loop through each element using forEach
  div.addEventListener("click", () => {
    url = "https://amazone-54bq.onrender.com/view";
   //  console.log("button was clicked");
    ViewPage(url);
})
});
...
document.addEventListener("DOMContentLoaded", () => {
  const updateQuantity = async (productId, action) => {
    try {
      let url = "https://amazone-54bq.onrender.com/cart/update";
